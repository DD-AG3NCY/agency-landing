        ...
        <main className="z-40 flex h-[100vh] items-center justify-center md:h-[100vh]">
          <div className="flex w-full max-w-6xl flex-col items-center justify-center gap-2">
            ...
            <Body2
              ...
              We are a curated group of
              professionals out of D_D
              focused on building web3
            ...
            <Link
              ...
              <Button
                className="font-paragraph drop-shadow-[3px_0_30px_rgba(228, 134,134, 0.872)] hover:drop-shadow-[10px_0_40px_rgba(228, 137, 137, 0.472)] mt-14 font-semibold transition-all"
                icon={<StarIcon />}
                iconPosition="left">
                Work with us
              </Button>
